...
class Plugin implements JsonSerializable
{
    ...
    {
        return $this->category === PluginFactory::get_categories()[PluginFactory::CATEGORY_BUNDLES] ? __('Buy bundle →', 'flexible-shipping-dhl-express') : __('Buy plugin →', 'flexible-shipping-dhl-express');
    }
}
