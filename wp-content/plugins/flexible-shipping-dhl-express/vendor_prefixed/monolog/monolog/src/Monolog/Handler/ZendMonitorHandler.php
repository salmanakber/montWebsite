...
class ZendMonitorHandler extends AbstractProcessingHandler
{
    ...
    public function __construct($level = Logger::DEBUG, bool $bubble = \true)
    {
        ...
        $this->levelMap = [Logger::DEBUG => \DhlVendor\ZEND_MONITOR_EVENT_SEVERITY_INFO, Logger::INFO => \DhlVendor\ZEND_MONITOR_EVENT_SEVERITY_INFO, Logger::NOTICE => \DhlVendor\ZEND_MONITOR_EVENT_SEVERITY_INFO, Logger::WARNING => \DhlVendor\ZEND_MONITOR_EVENT_SEVERITY_WARNING, Logger::ERROR => \DhlVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR, Logger::CRITICAL => \DhlVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR, Logger::ALERT => \DhlVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR, Logger::EMERGENCY => \DhlVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR];
