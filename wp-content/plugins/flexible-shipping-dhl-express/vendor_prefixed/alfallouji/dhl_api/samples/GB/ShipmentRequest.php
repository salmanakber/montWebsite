 ...
 * @version     0.1
 */
use DhlVendor\DHL\Entity\GB\ShipmentResponse;
use DhlVendor\DHL\Entity\GB\ShipmentRequest;
use DhlVendor\DHL\Client\Web as WebserviceClient;
use DhlVendor\DHL\Datatype\GB\Piece;
use DhlVendor\DHL\Datatype\GB\SpecialService;
...
echo \PHP_EOL . 'Executed in ' . (\microtime(\true) - $start) . ' seconds.' . \PHP_EOL;
