...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\DhlVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
