...
if (!\function_exists('DhlVendor\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \DhlVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('DhlVendor\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('DhlVendor\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \DhlVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('DhlVendor\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('DhlVendor\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \DhlVendor\WPDesk\Notice\Factory::notice($noticeContent, \DhlVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('DhlVendor\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('DhlVendor\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \DhlVendor\WPDesk\Notice\Factory::notice($noticeContent, \DhlVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('DhlVendor\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('DhlVendor\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \DhlVendor\WPDesk\Notice\Factory::notice($noticeContent, \DhlVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('DhlVendor\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('DhlVendor\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \DhlVendor\WPDesk\Notice\Factory::notice($noticeContent, \DhlVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('DhlVendor\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('DhlVendor\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \DhlVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('DhlVendor\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
