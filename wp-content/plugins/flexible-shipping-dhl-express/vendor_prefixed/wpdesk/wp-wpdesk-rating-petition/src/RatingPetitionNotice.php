...
class RatingPetitionNotice implements Hookable
{
    ...
    {
        new \DhlVendor\WPDesk\Notice\PermanentDismissibleNotice($this->get_notice_content(), $notice_name, \DhlVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO);
    }
    /**
     * Get notice content.
     *
    ...
    private function get_notice_content()
    {
        ...
        $content = sprintf(__('Awesome, you\'ve been using %s for more than 2 weeks. Could you please do me a BIG favor and give it a 5-star rating on WordPress? ~ Peter', 'flexible-shipping-dhl-express'), $this->plugin_name);
        $content .= '<br/>';
