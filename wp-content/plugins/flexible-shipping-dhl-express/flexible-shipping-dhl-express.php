<?php
/**
 * Plugin Name: Shipping Live Rates for DHL Express for WooCommerce
 * Plugin URI: https://wordpress.org/plugins/flexible-shipping-dhl-express/
 * Description: Shipping Live Rates for DHL Express shipping methods with real-time calculated shipping rates based on the established DHL Express API connection.
 * Version: 4.1.3
 * Author: Octolize
