...
class Activator {
	...
	private static function seed_defaults() {
		$defaults = array(
			...
			'max_tokens'            => 2048,
			'theme_color'           => '#1b3359',
			'welcome_message'       => 'Hi! I\'m here to help you find the right shirt — sizing, shipping, colours, whatever you need. What are you looking for?',
			'system_prompt'         => '',
			'store_policies'        => "Free shipping worldwide.\nCustom/made-to-measure shirts: up to 7 extra production days on top of normal delivery.\nCustom shirts are not returnable except for manufacturing defects.",
