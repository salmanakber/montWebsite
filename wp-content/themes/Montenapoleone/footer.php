...
<a href="#" class="up-arrow"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/arrow-up.png" alt=""></a>
<?php wp_footer(); ?>
...
<script src="//code.jivosite.com/widget/ShqvknIEy5" async></script>
<script type="text/javascript">
jQuery(document).ready(function(){
